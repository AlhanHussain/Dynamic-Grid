...
var body1 = document.getElementById("bd");

var productSection = elementCreation("section", body1);
var accessoriesSection = elementCreation("section", body1);
...
function sectionFiller(p) {
  var cardContainer, card, imgContainer, detailConatainer, name, brand, price;
  var i, j;
  if (p == "product") {
    i = 0;
    j = 5;
    cardContainer = elementCreation("div", productSection);
    cardContainer.className = "cardContainer1";
  } else {
    i = 5;
    j = 10;
    cardContainer = elementCreation("div", accessoriesSection);
    cardContainer.className = "cardContainer1";
  }

  for (var k = i; k < j; k++) {
    card = elementCreation("div", cardContainer);
    ...
    name.innerText = productList[k].name;
    brand.innerText = productList[k].brand;
    price.innerText = "Rs" + " " + productList[k].price;
    pre.src = productList[k].preview;
  }
}
sectionFiller("product");
sectionFiller("accessory");
